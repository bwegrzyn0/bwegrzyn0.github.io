...
\$$ \Omega_3=\Omega_{obr}= \frac{L_3}{I_3}, \$$
a $L_3=L\cos\theta$, więc
\$$ \Omega_{obr}= \frac{L}{I_3}\cos\theta. \$$
...
\$$ \Omega_{pr}= \frac{\Omega_1}{\sin\theta}= \frac{L_1}{I_1\sin\theta}= \frac{L\sin\theta}{I_1\sin\theta}= \frac{L}{I_1}. \$$
